...
- v1.0: `s3://kube-microvm-test-<ACCOUNT_ID>-us-east-1/uat/fixtures/microvm-hello-node.zip`
  - Returns: `{"status":"ok","path":"/","ts":"..."}`
- v2.0: `s3://kube-microvm-test-<ACCOUNT_ID>-us-east-1/uat/fixtures/microvm-net-test.zip`
