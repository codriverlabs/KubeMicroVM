...
> **Latest stable release: `v1.0.13`** — [Download](https://github.com/codriverlabs/KubeMicroVM/releases/latest)
>
...
CHART_VERSION=1.0.13   # replace with the version you want
